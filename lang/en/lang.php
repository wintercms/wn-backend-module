...
return [
    ...
    'list' => [
        ...
        'delete_selected_success_count' => '{1} Deleted 1 record.|[2,*] Deleted :count records.',
        'selection_page' => '{1} The record on this page is selected.|[2,*] All :count records on this page are selected.',
        'selection_select_all' => 'Select all :total matching records',
        'selection_select_all_unknown' => 'Select all matching records',
        'selection_all' => 'All :total records matching the current filters are selected.',
        'selection_all_unknown' => 'All records matching the current filters are selected.',
        'selection_clear' => 'Clear selection',
        'selection_confirm_all' => 'This applies to all :total records matching the current filters, not only the ones on this page.',
        'selection_confirm_all_unknown' => 'This applies to every record matching the current filters, not only the ones on this page.',
        'selection_stale' => 'The list has changed since those records were selected. Please check the list and select them again.',
        'selection_all_not_supported' => 'This list does not support selecting every record that matches the current filters.',
